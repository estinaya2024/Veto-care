        ...
        <div className="bg-white rounded-[3rem] p-10 md:p-16 shadow-lg mb-20 relative overflow-hidden">
          ...
          <form className="max-w-3xl mx-auto" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    {['Chien', 'Chat', 'Autre'].map((type) => (
                      <label key={type} className={cn(
                        "flex-1 flex items-center justify-center gap-2 p-4 border-2 rounded-xl cursor-pointer transition-all font-bold",
                        petType === type ? "border-veto-yellow bg-veto-yellow/5" : "border-gray-100 hover:border-veto-yellow"
                      )}>
                        <input 
                          type="radio" 
                          name="pet_type" 
                  ...
                  {petType === 'Autre' && (
                    <input 
                      ...
                      placeholder="Précisez l'espèce (ex: Perroquet, Lapin...)" 
                      className="w-full p-4 rounded-xl border-2 border-veto-yellow/30 focus:border-veto-yellow outline-none transition-all animate-fadeIn"
                    />
                  )}
                </div>
              </div>
            ...
            <div className="text-center">
              <Button 
                variant="black" 
                className="px-12 py-5 rounded-full font-extrabold hover:scale-105 transition-transform"
